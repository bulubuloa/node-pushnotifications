...
const sendGCM = (regIds, data, settings) => {
  ...
  const message = new gcm.Message({
    ...
    data: custom, // See https://github.com/phonegap/phonegap-plugin-push/blob/master/docs/PAYLOAD.md#android-behaviour
    notification: data.contentAvailable === true ? undefined : notification //trick for our project
  });

  message.addData('click_action',data.clickAction || data.category);
  let chunk = 0;
